  ...
  const faqData = [
    {
      ...
      answer:
        "Renting a tuktuk in Kandy offers you the perfect opportunity to discover the city at your leisure. We can help you obtain a temporary local driving license, so you can hit the road hassle-free.",
    },
    {
      id: 2,
      question: "Is it okay to drive a tuk-tuk in Kandy?",
      answer:
        "Yeah, driving a tuktuk in Kandy is totally safe. We'll even give you a lesson to make sure you feel confident behind the wheel.",
    },
    {
      id: 3,
      question: "What should I do if I encounter any problems while renting?",
      answer:
        "We're here to help you out every step of the way during your rental period. If you encounter any problems, just reach out to our customer support team, and we'll take care of it for you.",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      answer:
        "Certainly! You're welcome to leave the tuktuk in Kandy. You can find information about the fees for both pick-up and drop-off right here!",
    },
  ];
  return (
    <div>
      ...
      <div className="mt-10 lg:mx-12 xl:mx-28">
        <div>
          ...
          <p className="px-5 pt-8 lg:text-xl md:text-lg text-base text-justify">
            ...
            from a comfortable 19 to 28 degrees Celsius, making it ideal for
            outdoor adventures. As you wind your way along the roads, lined with
            verdant tea fields and ascend into the mountains, you'll be greeted
            by a refreshing breeze and the mystical touch of mist that blankets
            the landscape. Watch as the delicate breezes gently part the mist,
            revealing charming colorful homes nestled amidst Kandy's lush forest
            surroundings.
          </p>
          ...
          <p className="px-5 pt-8 lg:text-xl md:text-lg text-base text-justify">
            ...
            beautiful lake, offers a peaceful haven, enhanced by the ethereal
            mist that creates a captivating ambiance. Let yourself be captivated
          ...
          <ul className="px-10 lg:text-xl md:text-lg text-base leading-relaxed list-disc">
            <li>Choose Kandy as your pickup or drop-off location.</li>
            <li>Select the dates you need the tuktuk for.</li>
            <li>
              Opt for the tuktuk licence option to drive legally in Sri Lanka
              (we'll help you get a Recognition Permit).
            </li>
            <li>
              Customize your ride with extras like coolers, Bluetooth speakers,
              and baby seats
            </li>
          ...
          <p className="px-5 pt-5 lg:text-xl md:text-lg text-base text-justify">
            ...
            it's important to look into aspects like positive reviews, official
            registration, proper insurance coverage, safety measures, fair
            pricing, reliable customer service, license validation, training
          ...
          <p className="px-5 pt-5 lg:text-xl md:text-lg text-base text-justify">
            ...
            bind on the road, our roadside assistance team is just a call away.
            We believe in fair pricing, no sneaky charges here! Our dedication
            to open communication guarantees top-notch customer service and
            speedy resolution of any concerns you may have. And hey, we're proud
            to say we've taken steps to offset all our carbon emissions, doing
          ...
          <p className="px-5 pt-5 lg:text-xl md:text-lg text-base text-justify">
            ...
            architecture, take part in traditional ceremonies, and bask in the
            peaceful ambiance. Getting to this temple is hassle-free with your
          ...
          <p className="px-5 pt-5 lg:text-2xl text-xl font-bold">Kandy Lake</p>
          <p className="px-5 pt-5 lg:text-xl md:text-lg text-base text-justify">
            ...
            relish the serene atmosphere. When you're exploring Kandy, think
          ...
          <p className="px-5 pt-5 lg:text-xl md:text-lg text-base text-justify">
            ...
            orchids and the towering presence of a magnificent 40-meter-tall
            Javan fig tree. For a picturesque journey to this botanical
            paradise, opt for a scenic tuktuk ride. Just outside Kandy lies the
            sprawling expanse of the Royal Botanical Gardens of Peradeniya,
            inviting you to meander through themed gardens such as the majestic
            avenue of royal palms and the fascinating medicinal plant garden.
            Accessing these botanical marvels is made easy with the option to
          ...
          <p className="px-5 pt-5 lg:text-xl md:text-lg text-base text-justify">
            ...
            this city has to offer. Opt for a tuktuk rental for a hassle-free
          ...
          <p className="px-5 pt-5 lg:text-xl md:text-lg text-base text-justify">
            ...
            heritage of the country. For a convenient journey to the venue, why
          ...
          <p className="px-5 pt-5 lg:text-xl md:text-lg text-base text-justify">
            ...
            vistas of the picturesque surroundings. Opting for a tuktuk ride
            adds an extra charm to your journey to this memorable temple. Find
            it{" "}
            <a
          ...
          <p className="px-5 pt-5 lg:text-xl md:text-lg text-base text-justify">
            ...
            the art of tea production and indulge in a sip of delicious freshly
            brewed Ceylon tea. Getting to the Ceylon Tea Museum is a breeze with
          ...
          <p className="px-5 pt-5 lg:text-xl md:text-lg text-base text-justify">
            ...
            Depending on the train you choose, the travel time typically ranges
            from 2 to 3 hours. Sit back, unwind, and soak in the breathtaking
            views as you make your way to Kandy, the vibrant cultural hub of Sri
          ...
          <p className="px-5 pt-5 lg:text-xl md:text-lg text-base text-justify">
            ...
            hours, but it could vary based on traffic. Enjoy the scenic route
            filled with lush green landscapes and rolling hills as you make your
            way to the picturesque city of Kandy. For more details on routes and
          ...
          <p className="px-5 pt-5 lg:text-xl md:text-lg text-base text-justify">
            ...
            select any extras you need, and fill in your information. Proceed to
            the payment stage, and get ready to hit the road and experience the
            joy of tuktuk travel in Sri Lanka.
          </p>
          <div className="flex flex-col items-center my-10">
            <button
              onClick={homePageClick}
