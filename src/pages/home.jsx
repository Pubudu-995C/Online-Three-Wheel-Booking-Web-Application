          ...
          <div className="px-5 py-10 bg-gradient-to-tl from-lime-300 to-yellow-100 lg:py-10 ">
            <div>
              ...
              <p className="mt-12 text-lg text-center lg:text-xl">
                Hold on, you mean I get to cruise around in a three-wheeler in
                Sri Lanka? Absolutely! And trust me, you're going to have the
                time of your life!
              </p>
              ...
              <p className="mt-8 text-lg text-center lg:text-xl xl:px-40">
                ...
                Break away from the usual tourist spots and discover the hidden
                gems that often go unnoticed by others.
              </p>
            </div>
          ...
          <div className="px-5 pt-20 bg-gradient-to-tl from-lime-300 to-yellow-100">
            <div>
              ...
              <p className="mt-8 text-lg text-center lg:text-xl lg:mx-40">
                ...
                to schedule a complimentary travel consultation with our
                knowledgeable and enjoyable team.
              </p>
            </div>
          ...
          <div>
            <div>
              ...
              <p className="px-5 mt-8 text-lg text-center lg:text-xl">
                ...
                everything is included. Simply show up and we take care of the
                rest.
              </p>
            </div>
